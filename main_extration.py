...
from my_models_attacks.model_extration import *
...
@model_poisoner
def model_extractor(flexModel):
    params_dictionary = flexModel["model"].named_parameters()
    print(type(params_dictionary))
    model_extration_actk(params_dictionary)
    return flexModel
