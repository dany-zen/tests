...
from my_models_attacks.model_extration_utils.utils import run, basis, AcceptableFailure, cheat_get_inner_layers, which_is_zero
...
def get_ratios_lstsq(LAYER, critical_points, N, known_T, debug=False, eps=1e-5):
    ...
    for i,point in enumerate(critical_points):
        if globals.CHEATING:
            ...
            real = globals.A[which_layer][:,which_neuron]/globals.A[which_layer][0,which_neuron]
