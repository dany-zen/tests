...
from my_models_attacks.inversefed_for_gradient_attacks.nn import MetaMonkey
...
class GradientReconstructor():
    ...
    def _run_trial(self, x_trial, input_data, labels, dryrun=False):
        ...
        try:
            for iteration in range(max_iterations):
                #print("X_trial data antes:", x_trial.shape)
                ...
                with torch.no_grad():
                    ...
                    if (iteration + 1) % 500 == 0:
                        if self.config['filter'] == 'none':
                            ...
                            raise ValueError()
                    #print("X_trial data despues:", x_trial.shape)
    ...
    def _gradient_closure(self, optimizer, x_trial, input_gradient, label):
        ...
        def closure():
            ...
            #print("Dimensiones de las creadas antes", x_trial.shape)
            loss = self.loss_fn(self.model(x_trial), label)
            #print(loss)
            #print("Dimensiones de las creadas", x_trial.shape)
...
def reconstruction_costs(gradients, input_gradient, cost_fn='l2', indices='def', weights='equal'):
    ...
    #print("Cantidad de gradientes", len(input_gradient))
    ...
    for trial_gradient in gradients:
        ...
        for i in indices:
            if cost_fn == 'l2':
                ...
                #print("Calculo del costo:", costs, "Pesos:", weights[i], "Diferencia entre los gradientes:", (trial_gradient[i] - input_gradient[i]))
            elif cost_fn == 'l1':
        ...
        total_costs += costs
        print("Diferencia entre el coste", total_costs," y la longitud de gradientes", len(gradients))
