...
def data_poisoner_all(func):
    ...
    def _poison_Dataset_(
        ...
        **kwargs,
        ...
        def poison_func(dataset):
            try:                
                new_features, new_labels  = func(dataset, *args, **kwargs)
            except ValueError:
                raise ValueError(
        ...
        def moddify_all_dataset():
            new_features, new_labels  = poison_func(client_dataset)
