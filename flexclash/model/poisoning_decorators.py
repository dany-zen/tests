...
def model_inference_known_a_model_information(func):
    """
    Modificado para la inferencia
    Decorator that applies a poisoning function to a FlexModel object. The poisoning function should take a FlexModel object
    and return a poisoned FlexModel object.
    ...
    @functools.wraps(func)
    def _poison_inference_FlexModel_(
        model: FlexModel,
        *args,
        **kwargs,
    ):
        try:
            ...
            print("The decorated function: {func.__name__} had an error during execution")

    return _poison_inference_FlexModel_

def model_inference_known_agregator_information(func):
    """
    Modificado para la inferencia
    Decorator that applies a poisoning function to a FlexModel object. The poisoning function should take a FlexModel object
    and return a poisoned FlexModel object.
    ...
    @functools.wraps(func)
    def _poison_inference_aggregator_(
        aggregator_flex_model: FlexModel,
        *args,
        **kwargs,
    ):
        try:
            func(aggregator_flex_model["weights"], *args, **kwargs)
        except:
            print("The decorated function: {func.__name__} had an error during execution")

    return _poison_inference_aggregator_

def model_poison_agregator(func):
    """
    Modificado para la inferencia
    Decorator that applies a poisoning function to a FlexModel object. The poisoning function should take a FlexModel object
    and return a poisoned FlexModel object.
    ...
    @functools.wraps(func)
    def _poison_aggregator_(
        aggregator_flex_model: FlexModel,
        *args,
        **kwargs,
    ):
        try:
            aggregator_flex_model["weights"] = func(aggregator_flex_model["weights"], *args, **kwargs)
        except:
            print("The decorated function: {func.__name__} had an error during execution")

    return _poison_aggregator_